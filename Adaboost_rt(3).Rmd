...
# Test the Ada boosting regression tree model
...
```{r}
# compare with standard function (gbm)
...
gbm_model <- gbm(
  formula = as.formula(paste(outcome_variable, "~ .")),
...
rmse2 <- sqrt(mean((test_data[[outcome_variable]] - gbm_predictions) ^ 2))

cat("rmse of adaboost", rmse1, "\n", 
    "rmse of gbm (standard):", rmse2, "\n")
```
